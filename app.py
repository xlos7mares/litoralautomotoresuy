...
# 2. Definición de links (Sin lógica compleja para evitar errores)
base = "https://raw.githubusercontent.com/xlos7mares/litoralautomotoresuy/main/"

# 3. Estilos CSS (Directo al punto)
st.markdown("""
<style>
...
# 4. ENCABEZADO
logo_url = base + "601396473_3654982237974663_5290087789832669203_n.jpg"
st.markdown(f"""
...
# 5. CATÁLOGO (Uno por uno para que no falle)
st.markdown(f"""
<div class="grid-autos">
    <div class="tarjeta">
        <b style="color: #28a745;">EN VENTA</b>
        <h3>VW Saveiro (2011)</h3>
        <img src="{base}savblack1.jpg" class="img-car">
        <div class="precio">USD 8.000</div>
        <p>Motor 1.6 | Cabina Extendida</p>
        <a href="https://wa.me/59899417716?text=Interes%20Saveiro" class="btn" style="background:#007bff;">CONSULTAR</a>
        <a href="https://wa.me/59899417716?text=Interes%20Saveiro" class="btn" style="background:#dc3545;">ME INTERESA</a>
    </div>

    <div class="tarjeta">
        <b style="color: #28a745;">EN VENTA</b>
        <h3>Suzuki Vitara (2016)</h3>
        <img src="{base}suzukivitara13.jpg" class="img-car">
        <div class="precio">USD 14.800</div>
        <p>150k km | Impecable estado</p>
        <a href="https://wa.me/59899417716?text=Interes%20Vitara" class="btn" style="background:#007bff;">CONSULTAR</a>
        <a href="https://wa.me/59899417716?text=Interes%20Vitara" class="btn" style="background:#dc3545;">ME INTERESA</a>
    </div>

    <div class="tarjeta">
        <b style="color: #28a745;">EN VENTA</b>
        <h3>SMA C81 (2009)</h3>
        <img src="{base}655872262_3758670767605809_6449769683858621609_n.jpg" class="img-car">
        <div class="precio">USD 3.500</div>
        <p>Motor 1.8 | Full Full</p>
        <a href="https://wa.me/59899417716?text=Interes%20SMA" class="btn" style="background:#007bff;">CONSULTAR</a>
        <a href="https://wa.me/59899417716?text=Interes%20SMA" class="btn" style="background:#dc3545;">ME INTERESA</a>
    </div>

    <div class="tarjeta">
        <b style="color: #28a745;">EN VENTA</b>
        <h3>Hyundai Accent (95)</h3>
        <img src="{base}656015569_1109062323719001_1833132791485600122_n.jpg" class="img-car">
        <div class="precio">¡CONSULTE!</div>
        <p>Muy económico | Al día</p>
        <a href="https://wa.me/59899417716?text=Interes%20Hyundai" class="btn" style="background:#007bff;">CONSULTAR</a>
        <a href="https://wa.me/59899417716?text=Interes%20Hyundai" class="btn" style="background:#dc3545;">ME INTERESA</a>
    </div>
</div>
""", unsafe_allow_html=True)
